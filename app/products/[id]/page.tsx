        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col py-4">
            ...
            <div className="flex gap-4 mb-12">
              ...
              <Link href={`/products/${product.id}/try-on`} className="flex-1 bg-[#527661] text-white hover:bg-[#527661]/80 border border-transparent rounded-full py-4 text-xs font-bold tracking-widest uppercase transition-colors shadow-sm flex items-center justify-center gap-2">
